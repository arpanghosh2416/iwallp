export const investigations = [
  {
    ...
    metaDesc:
      "Explore general investigation services by Innerwork Advisors LLP in Kolkata. From background checks to surveillance, we deliver discreet and reliable solutions.",
  ...
  },
  {
    ...
    metaTitle: "Civil Investigation Services - Innerwork Advisors LLP, Kolkata",
    metaDesc:
      "Get expert civil investigation services in Kolkata with Innerwork Advisors LLP. We handle property disputes, contract frauds, and personal liability cases discreetly.",
  ...
  },
  {
    ...
    metaTitle:
      "Commercial Investigation Services - Innerwork Advisors LLP, Kolkata",
    metaDesc:
      "Innerwork Advisors LLP offers professional commercial investigation services in Kolkata. Uncover fraud, verify business partners, and protect your company’s interests.",
  ...
  },
  {
    ...
    metaTitle:
      "Criminal Investigation Services - Innerwork Advisors LLP, Kolkata",
    metaDesc:
      "Innerwork Advisors LLP provides expert criminal investigation services in Kolkata. We assist in uncovering evidence, verifying facts, and supporting legal action.",
  ...
  },
  {
    ...
    metaTitle:
      "Marital Investigation Services - Innerwork Advisors LLP, Kolkata",
    metaDesc:
      "Innerwork Advisors LLP offers discreet marital investigation services in Kolkata. Uncover infidelity, verify backgrounds, and protect your personal interests.",
  ...
  },
  {
    ...
    metaTitle:
      "Financial Investigation Services - Innerwork Advisors LLP, Kolkata",
    metaDesc:
      "Innerwork Advisors LLP offers expert financial investigation services in Kolkata. We trace assets, detect fraud, and uncover financial misconduct with precision.",
  ...
  },
  {
    ...
    metaTitle: "Fraud Investigation Services - Innerwork Advisors LLP, Kolkata",
    metaDesc:
      "Fraud investigation services in Kolkata by Innerwork Advisors LLP. Detect embezzlement, uncover scams, and safeguard your business with expert assistance.",
  ...
  },
  {
    ...
    metaTitle:
      "Industrial Investigation Services - Innerwork Advisors LLP, Kolkata",
    metaDesc:
      "Industrial investigation services in Kolkata by Innerwork Advisors LLP. Identify internal theft, policy violations, and workplace misconduct with expert help.",
  ...
  },
  {
    ...
    metaTitle:
      "Insurance Investigation Services - Innerwork Advisors LLP, Kolkata",
    metaDesc:
      "Insurance investigation services in Kolkata by Innerwork Advisors LLP. Verify claims, detect fraud, and ensure accurate settlements with professional support.",
  ...
  },
  {
    ...
    title: "Bringing Loved Ones Home",
    metaTitle: "Missing Person Tracing - Innerwork Advisors LLP, Kolkata",
    metaDesc:
      "Missing person tracing services in Kolkata by Innerwork Advisors LLP. Locate missing loved ones quickly and discreetly with our expert investigative support.",
    image:
  ...
  },
  {
    ...
    metaTitle: "Missing Heir Investigation - Innerwork Advisors LLP, Kolkata",
    metaDesc:
      "Missing heir investigation services in Kolkata by Innerwork Advisors LLP. Expertly trace and locate rightful heirs to ensure smooth legal and estate settlements.",
  ...
  },
  {
    ...
    title: "Establishing Facts, Supporting Your Claim",
    metaTitle:
      "Personal Injury Investigation - Innerwork Advisors LLP, Kolkata",
    metaDesc:
      "Personal injury investigation services in Kolkata by Innerwork Advisors LLP. Get expert evidence gathering and case support to strengthen your injury claims.",
    image:
  ...
  },
  {
    ...
    title: "Investigating Defects, Ensuring Accountability",
    metaTitle:
      "Product Liability Investigation - Innerwork Advisors LLP, Kolkata",
    metaDesc:
      "Product liability investigation services in Kolkata by Innerwork Advisors LLP. Expertly investigate defects, safety issues, and support legal claims with thorough analysis.",
    image:
  ...
  },
  {
    ...
    title: "Examining Standards of Care, Seeking Justice",
    metaTitle:
      "Professional Negligence Investigation - Innerwork Advisors LLP, Kolkata",
    metaDesc:
      "Professional negligence investigation in Kolkata by Innerwork Advisors LLP. Uncover malpractice, build strong cases, and protect your rights with expert assistance.",
    image:
  ...
  },
  {
    ...
    title: "Addressing Threats, Ensuring a Safe Environment",
    metaTitle:
      "Workplace Violence Investigation - Innerwork Advisors LLP, Kolkata",
    metaDesc:
      "Workplace violence investigation services in Kolkata by Innerwork Advisors LLP. Identify incidents, gather evidence, and help ensure a safer work environment.",
    image:
  ...
  },
  {
    ...
    metaDesc:
      "Worker compensation verification services in Kolkata by Innerwork Advisors LLP. Ensure claim accuracy, detect fraud, and protect your business with expert investigation.",
    image:
  ...
  {
    name: "Elder Abuse",
    title: "Protecting Vulnerable Individuals, Ensuring Their Well-being",
    metaTitle: "Elder Abuse Investigation - Innerwork Advisors LLP, Kolkata",
    metaDesc:
      "Elder abuse investigation in Kolkata by Innerwork Advisors LLP. We sensitively detect neglect and abuse to protect the safety and well-being of senior loved ones.",
  ...
  },
  {
    ...
    title: "Facilitating the Safe Return of Children",
    metaTitle:
      "Child Retrieval Investigation - Innerwork Advisors LLP, Kolkata",
    metaDesc:
      "Child retrieval investigation services in Kolkata by Innerwork Advisors LLP. Expertly assist in locating and safely recovering children in custody or abduction cases.",
    image:
  ...
  {
    name: "Internet Fraud",
    title: "Combating Online Deception, Protecting Your Digital Assets",
    metaTitle: "Cyber Fraud Investigation - Innerwork Advisors LLP, Kolkata",
    metaDesc:
      "Cyber fraud investigation services in Kolkata by Innerwork Advisors LLP. Detect online scams, data breaches, and cybercrime to protect your digital assets effectively.",
    image:
  ...
  {
    name: "Identity Theft",
    title: "Recovering Your Identity, Preventing Future Harm",
    metaTitle:
      "Theft Identification Investigation - Innerwork Advisors LLP, Kolkata",
    metaDesc:
      "Theft identification investigation services in Kolkata by Innerwork Advisors LLP. Expertly uncover theft incidents, gather evidence, and support legal actions effectively.",
    image:
